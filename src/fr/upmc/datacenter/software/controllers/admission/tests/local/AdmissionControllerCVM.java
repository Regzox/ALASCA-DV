...
public class AdmissionControllerCVM extends AbstractCVM {
	...
	public AdmissionControllerCVM() throws Exception {
		super();
	...
	public void connect() throws Exception {
		...
		/** INSTANCIATION DU CONTROLEUR D'ADMISSIONS **/
		
		List<LogicalResourcesProviderPortsDataI> lrppdis = new ArrayList<>();
		
		lrppdis.add(lrppdi_A);
		lrppdis.add(lrppdi_B);

...
java -cp 'jars/*' -Djava.security.manager -Djava.security.policy=dcvm.policy fr.upmc.datacenter.software.admissioncontroller.tests.distributed.AdmissionControllerCVM %1 config.xml